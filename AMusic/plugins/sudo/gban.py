...
from AMusic.utils import get_readable_time
...
from AMusic.utils.extraction import extract_user
from config import BANNED_USERS


@app.on_message(filters.command(["gban", "globalban","g"]) & SUDOERS)
@language
...
@app.on_message(filters.command(["ungban","gunban"]) & filters.user(OWNER_ID))
@language
